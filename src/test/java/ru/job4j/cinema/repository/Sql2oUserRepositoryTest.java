...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        var optionalUser = sql2oUserRepository.save(new User(0, "Valeri", "Voltron7@gmail.com", "777"));
    ...
    public void whenSaveSeveralThenGetAll() {
        var user1 = sql2oUserRepository.save(new User(0, "name1", "email1@gmail.com", "123"));
        var user2 = sql2oUserRepository.save(new User(0, "name2", "email2@gmail.com", "456"));
        var user3 = sql2oUserRepository.save(new User(0, "name3", "email3@gmail.com", "789"));
    ...
    public void whenUserIsAlreadyExistsThenException() {
        User user = new User(1, "Val", "Val@gmail.com", "333");
